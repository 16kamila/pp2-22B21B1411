...
GAMEOVER_font = pygame.font.Font("game_over.ttf", 250)
...
def game_over():
    Gf = GAMEOVER_font.render("game over :(", True, "blue")
    GameOver_rect = Gf.get_rect(center=(WIDTH/2, HEIGHT/2))
    SCREEN.blit(Gf, GameOver_rect)
    pygame.display.flip()
    time.sleep(2)
    pygame.quit()
    quit()
